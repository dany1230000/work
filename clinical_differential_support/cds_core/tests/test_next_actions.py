...
class NextActionDownstreamReadinessTests(TestCase):
    ...
    def test_selector_advances_to_general_catalog_import_when_downstream_audits_are_clear(self):
        ...
        self.assertEqual(plan["general_catalog"]["condition_count"], 400)
        self.assertEqual(plan["general_catalog"]["source_count"], 478)
        self.assertEqual(
    ...
    def test_staff_next_action_page_renders_downstream_readiness(self):
        ...
        self.assertContains(response, "400 conditions")
        self.assertContains(response, "478 sources")
    ...
    def test_staff_next_action_json_includes_summary_only_downstream_readiness(self):
        ...
        self.assertEqual(payload["general_catalog"]["condition_count"], 400)
        self.assertEqual(payload["general_catalog"]["source_count"], 478)
        self.assertEqual(
