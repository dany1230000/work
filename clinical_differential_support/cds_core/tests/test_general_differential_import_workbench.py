...
class GeneralDifferentialImportWorkbenchTests(TestCase):
    ...
    def test_report_builds_next_batch_and_import_pipeline(self):
        ...
        self.assertEqual(report["summary"]["condition_count"], 325)
        self.assertEqual(report["summary"]["source_count"], 404)
        self.assertEqual(
    ...
    def test_staff_json_export_contains_governance_metadata_only(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(payload["summary"]["condition_count"], 325)
        self.assertEqual(payload["summary"]["source_count"], 404)
